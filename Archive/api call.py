...
# GOES Aggregated: PSM 4 API call example
# url = "https://developer.nrel.gov/api/nsrdb/v2/solar/nsrdb-GOES-aggregated-v4-0-0-download.json?api_key=GGkBibjKJxaCaiQ8giyDyYvvd3luSAJM7HEJhvDB"
